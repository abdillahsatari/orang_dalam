...
<head>
   ...
   <title>PT. Orang Dalam Indonesia | Official Mail</title><!--[if (mso 16)]>
    <style type="text/css">
...
<body data-new-gr-c-s-loaded="14.1094.0" style="width:100%;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;padding:0;Margin:0">
                                          ...
                                          <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;background-color:#ffffff;border-radius:4px" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff" role="presentation">
                                             <tr style="border-collapse:collapse">
                                                <td align="center" style="Margin:0;padding-bottom:5px;padding-left:30px;padding-right:30px;padding-top:35px">
                                                   <h1 style="Margin:0;line-height:42px;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:35px;font-style:normal;font-weight:normal;color:#111111">Registrasi Peserta</h1>
                                                </td>
                                             </tr>
                                             <tr style="border-collapse:collapse">
                                          ...
                                          <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;border-radius:4px;background-color:#ffffff" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff" role="presentation">
                                             <tr style="border-collapse:collapse">
                                                <td class="es-m-txt-l" bgcolor="#ffffff" align="left" style="Margin:0;padding-top:20px;padding-bottom:20px;padding-left:30px;padding-right:30px">
                                                   <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px;text-align:center;">Dear <?php echo $user['memberFullName']; ?>, Terimakasih telah melakukan pendaftaran pada kelas <?php echo $user['courseName']; ?> PT. Orang Dalam Indonesia. Berikut adalah rincian pendaftaran kelas yang anda daftarkan:</p>
                                                </td>
                                             </tr>
                                             <tr style="border-collapse:collapse">
                                                <td align="center" style="Margin:0;padding-left:30px;padding-right:30px;padding-top:35px;padding-bottom:35px">
                                             ...
                                             <tr style="border-collapse:collapse">
                                                <td class="es-m-txt-l" bgcolor="#ffffff" align="left" style="Margin:0;padding-top:20px;padding-bottom:20px;padding-left:30px;padding-right:30px">
                                                   <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px;text-align:center;">
                                                   Mohon berhati-hati terhadap modus penipuan yang mengatasnamakan PT. Orang Dalam Indonesia. Info resmi hanya disalurkan melalui email <span style="font-weight: 300">support@orangdalam.co.id</span> dan nomor
                                                   <span style="font-weight: 300">081240280088</span>
                                                   </p>
                                                </td>
                                             </tr>
